...
export const EMAIL_PAGE_CLICK_TERMS_CONDITIONS = 'EMAIL_PAGE_CLICK_TERMS_CONDITIONS';
export const EMAIL_PAGE_CLICK_PRIVACY_POLICY = 'EMAIL_PAGE_CLICK_PRIVACY_POLICY';
